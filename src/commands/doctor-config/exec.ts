...
import { asObjectRecord } from "./utils.js";
...
export type ExecSafeBinScopeRef = {
  scopePath: string;
  safeBins: string[];
...
export function collectExecSafeBinScopes(cfg: OpenClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinTrustedDirHints(cfg: OpenClawConfig): ExecSafeBinTrustedDirHintHit[] {
